...
<html lang="en">
  <head>
    ...
    <title>Notulen Online Pengadilan Negeri Tais | @yield('title') </title>
      ...
      <div class="main_container" style="background:#013C62;">
        ...
        <footer style="overflow:hidden;">
          <div class="pull-right">
            Copyright © 2021  <a href="https://manicbenteng.sch.id/" target="_blank">Pengadilan Negeri Tais, Provinsi Bengkulu</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
