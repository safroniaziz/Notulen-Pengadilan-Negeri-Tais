...
<html>
	<head>
		<meta charset="utf-8">
        <title>Notulis Pengadilan Negeri Tais | Login</title>
		...
		<div id="particles-js">
            <div class="loginBox">
                ...
                @if ($errors->any())
                    ...
                    <p style="text-align:center; margin-bottom:20px;">Aplikasi Pencatatan Notulen Kegiatan Pengadilan Negeri Tais</p>
                @endif
